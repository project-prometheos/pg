...
Example:
    >>> from pg_math import FormulaUpToConstant, get_context
    ...
    def cmp(self, **options):
        ...
        def checker(student_answer: str) -> Dict[str, Any]:
            ...
            try:
                    ...
                    if SYMPY_AVAILABLE and student._sympy_expr:
                        ...
                        potential_constants = [
                            ...
                            if (len(str(s)) == 1 and 
                                ...
                                str(s) not in correct_vars)  # Exclude problem variables
                        ]
                        ...
                        if len(potential_constants) == 0:
                            ...
                            try:
                                student = FormulaUpToConstant(student, context=self._private_context)
                ...
                # Compare
                equal, error_msg = self.compare_up_to_constant(student, tolerance)
