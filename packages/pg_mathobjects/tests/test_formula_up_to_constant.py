...
from pg_mathobjects import Context, Formula, FormulaUpToConstant, Compute
...
class TestFormulaUpToConstantOperations:
    ...
    def test_remove_constant_method(self):
        ...
        assert g._tree.equals(Formula("x^2/2")._tree)
