...
def validate_factored_polynomial(formula_obj) -> None:
    """
    ...
    Raises:
        ValueError: If formula is not in valid factored polynomial form
    """
    ...
    is_valid, error_msg = validator.validate(formula_obj._tree)
