...
class MacroRegistry:
    ...
    def load(self, filename: str) -> Dict[str, Any]:
        ...
        module_map = {
            "PGstandard.pl": "pg_macros.pg_macros.pg_standard",
            "PGcourse.pl": "pg_macros.pg_macros.pg_course",
            "PG.pl": "pg_macros.pg_macros.core.pg_core",
            "PGbasicmacros.pl": "pg_macros.pg_macros.core.pg_basic_macros",
            "MathObjects.pl": "pg_macros.pg_macros.math_objects",
            "PGML.pl": "pg_macros.pg_macros.pgml",
            "PGanswermacros.pl": "pg_macros.pg_macros.answers.pg_answer_macros",
            "PGchoicemacros.pl": "pg_macros.pg_macros.pg_choice",
            "PGgraphmacros.pl": "pg_macros.pg_macros.pg_graph",
            "AnswerFormatHelp.pl": "pg_macros.pg_macros.answer_format_help",
            "parserPopUp.pl": "pg_macros.pg_macros.parser_popup",
            "parserMultiAnswer.pl": "pg_macros.pg_macros.parser_multi_answer",
            "contextFraction.pl": "pg_macros.pg_macros.context_fraction",
            "niceTables.pl": "pg_macros.pg_macros.ui.nice_tables",
            "scaffold.pl": "pg_macros.pg_macros.ui.scaffold",
        }
        ...
        try:
            ...
            if hasattr(module, '__exports__'):
                exports = {name: getattr(module, name) for name in module.__exports__}
            else:
                exports = {
