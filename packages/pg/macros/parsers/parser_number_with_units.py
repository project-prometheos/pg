...
class NumberWithUnits:
    ...
    def __init__(self, value: Union[int, float, str] = 0, units: str = '', **kwargs):
        """
        ...
        """
        try:
            self.value = float(value) if isinstance(
                value, (int, float, str)) else value
...
class AnswerChecker:
    ...
    def check(self, student_answer: str) -> dict:
        ...
        try:
            ...
            value_correct = abs(
                student_value - self.correct.value) <= tolerance
