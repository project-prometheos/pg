...
print(
    f"Statement HTML: {len(result.statement_html) if result.statement_html else 0} chars")
print(
    f"Answer blanks: {len(result.answer_blanks) if result.answer_blanks else 0}")
print(
    f"Solution HTML: {len(result.solution_html) if result.solution_html else 0} chars")
